...
export const experienceMeta: Record<string, ExtraMeta> = {
  ...
  "camel-safari-jaisalmer": story(
    ...
    [desertSafari, jaisalmerFort, villageTour, royalTour],
    {
      ...
      willExperience: [
        "Welcome with cool nimbu pani at the dune edge",
      ...
      flow: [
        ...
        "Meet your camel-walla and camel",
  ...
  "luxury-desert-camping-jaisalmer": story(
    ...
    [jaisalmerFort, desertSafari, culturalDance, royalTour],
    {
      ...
      overview:
        "Step inside your own private Swiss tent: king-size bed, hand-block-printed linens, en-suite bathroom and a private deck looking out over endless dunes. As the sun lowers, take a sundowner camel ride, then return to a candle-lit Rajasthani thaal under the open sky. Kalbelia dancers swirl around the bonfire, the Manganiyar singers strum into the night, and finally — silence, stars and the softest desert breeze.\n\nThis is the Thar Desert reimagined as a five-star sanctuary.",
      unique: [
      ...
      willExperience: [
        ...
        "Candle-lit Rajasthani royal thaal dinner",
  ...
  "jeep-safari-thar": story(
    ...
    [desertSafari, villageTour, jaisalmerFort, royalTour],
    {
      ...
      overview:
        "Strap in for a high-octane 4x4 ride across the wild Thar — bouncing over giant dunes, racing into golden valleys and stopping at hidden Bishnoi and Manganiyar villages most tourists never see. Your driver knows every track, every shortcut, every story. End at a panoramic dune for the ultimate desert sunset.\n\nThis is the desert at full throttle.",
      unique: [
  ...
  "sandboarding-jaisalmer": story(
    ...
    [desertSafari, jaisalmerFort, villageTour, royalTour],
    {
      ...
      idealFor: ["Adventure travelers", "Friends & couples", "Active families", "Bucket-list seekers"],
  ...
  "desert-stargazing": story(
    ...
    [jaisalmerFort, desertSafari, royalTour, villageTour],
    {
      ...
      overview:
        "Far from the lights of any city, the Thar Desert reveals the Milky Way in spectacular detail. Lie back on traditional Rajasthani razais, sip warm chai and learn the stories of the constellations from a local astronomy guide with a high-powered telescope. A magical, romantic and humbling experience — perfect after a sunset camel ride.",
      unique: [
      ...
      idealFor: ["Couples & honeymooners", "Families with curious kids", "Wellness travelers", "Photographers"],
  ...
  "ethical-elephant-experience-jaipur": story(
    ...
    [royalTour, amberFort, villageTour, hawaMahal],
    {
      ...
      idealFor: ["Animal lovers", "Families with children 8+", "Ethical travelers", "Photographers"],
  ...
  "leopard-safari-jawai": story(
    ...
    [ranthamboreTiger, villageTour, royalTour, jaisalmerFort],
    {
      ...
      idealFor: ["Wildlife enthusiasts", "Photographers", "Off-the-path luxury travelers", "Couples"],
  ...
  "tiger-safari-ranthambore": story(
    ...
    [ranthamboreTiger, royalTour, villageTour, amberFort],
    {
      ...
      idealFor: ["Wildlife travelers", "Families", "Photographers", "First-time India visitors"],
  ...
  "bird-watching-bharatpur": story(
    ...
    [udaipurLake, jalMahal, ranthamboreTiger, villageTour],
    {
      ...
      idealFor: ["Birders & ecologists", "Wildlife photographers", "Slow travelers", "Families"],
  ...
  "marwari-horse-riding": story(
    ...
    [royalTour, villageTour, amberFort, hawaMahal],
    {
      ...
      idealFor: ["Riders of all levels", "Couples", "Solo adventurers", "Multi-day equestrian travelers"],
  ...
  "palace-hotel-stays-rajasthan": story(
    ...
    [royalTour, heroPalace, cityPalace, udaipurLake, amberFort],
    {
      ...
      idealFor: ["Honeymooners", "Anniversary couples", "Luxury travelers", "Special occasions"],
  ...
  "royal-dining-experience": story(
    ...
    [rajasthaniFood, royalTour, cityPalace, hawaMahal],
    {
      ...
      unique: [
        ...
        { title: "Master chef menu", text: "7-course slow-cooked Rajasthani thaal." },
        { title: "Live classical music", text: "Sitar, sarangi or vocal accompaniment." },
        { title: "Royal welcome", text: "Garlanding, safa-tying and aarti." },
      ],
      willExperience: [
        "Welcome with safa, tilak and garlands",
        "Aperitif on the haveli terrace",
        "7-course royal Rajasthani thaal",
      ...
      idealFor: ["Couples", "Anniversary celebrations", "Foodies", "Luxury travelers"],
  ...
  "vintage-car-ride-udaipur": story(
    ...
    [luxuryCar, udaipurLake, royalTour, cityPalace],
    {
      ...
      idealFor: ["Couples & honeymooners", "Anniversaries & proposals", "Weddings & pre-wedding shoots", "Luxury travelers"],
  ...
  "rajasthani-cooking-class": story(
    ...
    [rajasthaniFood, localMarket, villageTour, royalTour],
    {
      ...
      perfectMoments: ["Kneading dough beside grandma", "Spices being hand-ground in a stone chakki", "Sitting down to eat your own feast"],
      flow: ["Hotel pickup", "Spice market visit", "Cook with the family", "Eat together", "Return with recipes"],
      idealFor: ["Foodies", "Couples", "Families", "Solo cultural travelers"],
  ...
  "street-food-tour-jaipur": story(
    ...
    [localMarket, rajasthaniFood, hawaMahal, jalMahal],
    {
      ...
      willExperience: [
        ...
        "Sweet finale at a legendary mithai house",
      ],
      willFeel: "Stuffed, smiling and instantly in love with Jaipur.",
      perfectMoments: ["Sizzling kachoris fresh out of oil", "Cold lassi in a clay kulhar", "Pink City lanes lit at night"],
      flow: ["Meet at old city", "Walking food tour", "8–10 stops", "Sweet finale", "Drop-off"],
      idealFor: ["Foodies", "Couples", "Solo travelers", "Friends"],
  ...
  "traditional-rajasthani-thali": story(
    ...
    [rajasthaniFood, royalTour, villageTour, cityPalace],
    {
      ...
      idealFor: ["Families", "Couples", "Cultural travelers", "First-time India visitors"],
  ...
  "village-lunch-rajasthan": story(
    ...
    [villageTour, rajasthaniFood, royalTour, ranthamboreTiger],
    {
      ...
      unique: [
        ...
        { title: "Optional opium tradition", text: "Sacred Bishnoi welcome ritual (alcohol-free)." },
      ],
      ...
      idealFor: ["Cultural travelers", "Families", "Slow-travel lovers", "First-time visitors"],
  ...
  "spice-market-tour-jaipur": story(
    ...
    [localMarket, rajasthaniFood, hawaMahal, royalTour],
    {
      ...
      idealFor: ["Foodies", "Home cooks", "Cultural travelers", "Photographers"],
