...
export const tourDetails: Record<string, TourDetail> = {
  ...
  "golden-triangle-royal-rajasthan-tour": {
    slug: "golden-triangle-royal-rajasthan-tour",
    title: "Golden Triangle & Royal Rajasthan Tour",
    tagline: "India's Golden Triangle meets the royal heart of Rajasthan.",
    duration: "9 Nights / 10 Days",
    price: "Contact Us",
    overview:
      "Experience the perfect blend of India's iconic landmarks and Rajasthan's royal heritage. Visit the majestic Taj Mahal, explore Jaipur's royal palaces, discover the spiritual charm of Pushkar, wander through the Blue City of Jodhpur, and enjoy the romantic lakes of Udaipur.",
    arrivalOptions: [
      "Indira Gandhi International Airport (Delhi)",
      "Delhi Railway Station",
    ],
    departureOptions: [
      "Udaipur Airport",
      "Optional onward transfer to Jaipur or Delhi",
    ],
    itinerary: [
      {
        day: 1,
      ...
      },
      {
        day: 2,
        title: "Delhi to Agra",
        activities: ["Taj Mahal", "Agra Fort", "Mehtab Bagh (optional)"],
        overnight: "Agra",
      },
      {
        day: 3,
        title: "Agra to Jaipur",
        activities: ["Fatehpur Sikri", "Chand Baori Stepwell", "Arrival in Jaipur"],
        overnight: "Jaipur",
      },
      {
        day: 4,
      ...
      },
      {
        ...
        activities: ["Brahma Temple", "Pushkar Lake", "Local Market", "Sunset Point"],
        overnight: "Pushkar",
      },
      {
        day: 6,
        title: "Pushkar to Jodhpur",
        activities: ["Clock Tower Market", "Evening at Leisure"],
        overnight: "Jodhpur",
        note: {
          title: "Pushkar to Jodhpur Transfer Options",
          options: [
            { label: "Option 1 — Private Drive", details: ["Approx. 4–5 hours by private air-conditioned vehicle"] },
            {
              label: "Option 2 — Train Transfer",
              details: [
                "Ajmer Railway Station to Jodhpur",
                "Pickup available at Jodhpur Station",
              ],
            },
          ],
          footer: "Train tickets can be arranged on request.",
        },
      },
      {
        day: 7,
    ...
    accommodationOptions: [
      ...
      "4-star comfort properties",
      "5-star luxury palace stays on request",
    ],
    inclusions: [
    ...
    whyChoose: [
      "Perfect blend of Golden Triangle and Royal Rajasthan",
      "Covers culture, history, architecture, spirituality, forts, palaces and lakes",
      "Flexible Pushkar–Jodhpur transfer: private car or train",
      "Private chauffeur-driven journey at your own pace",
      "Planned by Jaipur-based specialists with 20+ years' experience",
    ],
    seoKeywords: [
      "Golden Triangle and Rajasthan tour",
      "Delhi Agra Jaipur Pushkar Jodhpur Udaipur tour",
      "10 days Rajasthan tour package",
      "Golden Triangle with Udaipur",
      "Royal Rajasthan private tour",
    ],
    metaTitle: "Golden Triangle & Royal Rajasthan Tour | Delhi Agra Jaipur Pushkar Jodhpur Udaipur",
    metaDescription:
      "Book the Golden Triangle & Royal Rajasthan Tour with Heritage Jaipur Travels. Visit Delhi, Agra, Jaipur, Pushkar, Jodhpur and Udaipur in a 10-day private Rajasthan journey.",
  },
};
