...
export const tourDetails: Record<string, TourDetail> = {
  ...
  "jaipur-heritage": {
    ...
    tagline: "Discover the timeless beauty of the Pink City's royal palaces and forts.",
    duration: "2 Days / 1 Night",
    price: "From ₹7,999",
    overview:
      "A perfect short getaway to explore the iconic heritage sites of Jaipur. Visit the magnificent Amber Fort, the stunning City Palace, the astronomical marvel Jantar Mantar, and the iconic Hawa Mahal.",
    arrivalOptions: ["Jaipur International Airport", "Jaipur Railway Station"],
    departureOptions: ["Jaipur Airport / Railway Station"],
    itinerary: [
      {
        day: 1,
        title: "Arrival & Jaipur Sightseeing",
        activities: [
          "Pickup from Jaipur Airport / Railway Station",
          "Visit Amber Fort with jeep ride",
      ...
      {
        day: 2,
        title: "Jaipur Exploration & Departure",
        activities: [
          "Visit Jantar Mantar (UNESCO site)",
          "Explore Nahargarh Fort for panoramic views",
    ...
    accommodationOptions: ["Standard (3★)", "Deluxe (4★)", "Heritage Hotels"],
    inclusions: ["Airport/Station pickup & drop", "Private AC vehicle", "Hotel accommodation", "Breakfast", "Sightseeing as per itinerary"],
    exclusions: ["Flights", "Entry fees", "Personal expenses", "Travel insurance"],
    idealFor: ["Weekend travelers", "First-time visitors to Jaipur", "Heritage enthusiasts"],
    whyChoose: ["Expert local guides", "Fully private tour", "Customizable schedule"],
    seoKeywords: ["Jaipur heritage tour", "Jaipur sightseeing package", "Jaipur 2 day tour"],
    metaTitle: "Jaipur Heritage Tour – 2 Days | Heritage Jaipur Travels",
    metaDescription: "Explore Jaipur's Amber Fort, City Palace, Hawa Mahal & more in our 2-day heritage tour. Private AC vehicle & expert guides. Book now!",
  },
  "golden-triangle": {
